...
class MyFRichCurveEditorModelNamed : public FRichCurveEditorModel
{
public:
	MyFRichCurveEditorModelNamed(const FSmartName& InName, ERawCurveTrackTypes InType, int32 InCurveIndex, UAnimSequenceBase* InAnimSequence, FCurveEditorTreeItemID InTreeId = FCurveEditorTreeItemID())
...
class MORPHVIEWERPLUGIN_API MyAnimSequenceCurveEditor : public IAnimSequenceCurveEditor, public FEditorUndoClient
{
	SLATE_BEGIN_ARGS(MyAnimSequenceCurveEditor) {}
...
public:
	MyAnimSequenceCurveEditor();
	~MyAnimSequenceCurveEditor();

	/** Custom Function */
	TSharedPtr<FCurveEditor> GetCurveEditor() { return CurveEditor; };
